...
DisplayData global_display_data =
{
	...
	.temp_min = FLT_MAX,
	.pressure_hpa = 0.0f,
	.pressure_hpa_max = -FLT_MAX,
	.pressure_hpa_min = FLT_MAX,
	.light_percentage_value = 0.0f,
	.light_percentage_max = -FLT_MAX,
	.light_percentage_min = FLT_MAX
};

static void Env_UpdateMaxAndMin(void)
{
	...
	if (global_display_data.pressure_hpa > global_display_data.pressure_hpa_max)
	{
		global_display_data.pressure_hpa_max = global_display_data.pressure_hpa;
	}

	if (global_display_data.pressure_hpa < global_display_data.pressure_hpa_min)
	{
		global_display_data.pressure_hpa_min = global_display_data.pressure_hpa;
	}
}
...
void StartUpdateDataTask(void *argument)
{
	while (1)
	{
		...
		if (global_display_data.dht11_check_result == DHT11_DATA_OK)
		{
			...
			global_display_data.pressure_hpa = sensor_data->pressure_hpa;
			Env_UpdateMaxAndMin();
		}
